...
```{r, echo = FALSE}
dat <- read.csv("https://raw.githubusercontent.com/joetsui1994/Mbiol-Practical-2025/refs/heads/main/Data/nation_newCasesBySpecimenDate.csv")
```
...
```{r Estimate variant Rt, echo=TRUE, fig.keep = "none"}
