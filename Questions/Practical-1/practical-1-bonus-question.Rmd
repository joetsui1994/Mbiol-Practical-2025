...
```{r get-frequencies, message=FALSE, warning=FALSE, eval=FALSE}
...
```{r plot-daily-frequencies-stacked, message=FALSE, warning=FALSE, eval=FALSE}
library(ggplot2)
