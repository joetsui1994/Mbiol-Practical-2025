...
spmod2 = glm(y95 ~ foi2, family = binomial(), data = filipendula)
...
where \(l_{j,i}I_j\) is the gravity-weighted force of infection exerted by location \(j\) on location \(i\). \(\beta\) is the transmission coefficient, \(I\) is number of infected individuals, \(S\) number of susceptibles, and \(\gamma\) is the recovery rate.
